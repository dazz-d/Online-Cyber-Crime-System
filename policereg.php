...
<html>
   ...
   <body text="lightgrey" background="wh.jfif">
	    <div class="nav-fix">
			<div style="background-color: black;">
				<h1 style="margin-left:50px; margin-right:200px;font-size: 50px; color:whitesmoke;font:bold;">CYBER CRIME RECORDS MANAGEMENT SYSTEM</h1> 
			</div>
		<div>
  	<div><h2><a href="policeloginregister.php">Back</a></h2></div>
        <h1 style="margin-left:414px;font:bold;font-size:45px;margin-top:50px; color:black;"> POLICE REGISTERATION </h1>
